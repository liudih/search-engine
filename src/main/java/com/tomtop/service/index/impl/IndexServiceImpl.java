	...
	public String insertBlukIndex(String indexName, String indexType,List<IndexEntity> prods) {
		...
		try{
			...
			for (IndexEntity indexEntity : prods) {
				String jsonProduct = JSONObject.toJSONString(indexEntity);
			...
			if (bulkResponse.hasFailures()) {
				org.apache.commons.io.FileUtils.writeStringToFile(new File(Config.getValue("error.log.path")+"error.log"), bulkResponse.buildFailureMessage(),true);
