...
public class MutilLanguage implements Cloneable{
	...
	//类目1
	private ProductTypeEntity productLevel1;
	//类目2	
	private ProductTypeEntity productLevel2;
	//类目3	
	private ProductTypeEntity productLevel3;
	...
	public ProductTypeEntity getProductLevel1() {
		return productLevel1;
	}

	public void setProductLevel1(ProductTypeEntity productLevel1) {
		this.productLevel1 = productLevel1;
	}

	public ProductTypeEntity getProductLevel2() {
		return productLevel2;
	}

	public void setProductLevel2(ProductTypeEntity productLevel2) {
		this.productLevel2 = productLevel2;
	}

	public ProductTypeEntity getProductLevel3() {
		return productLevel3;
	}

	public void setProductLevel3(ProductTypeEntity productLevel3) {
